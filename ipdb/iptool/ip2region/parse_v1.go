...
func New(path string) (*Ip2RegionV1, error) {
...
func (this *Ip2RegionV1) Close() {
	this.dbFileHandler.Close()
}

func (this *Ip2RegionV1) MemorySearch(ipStr string) (ipInfo IpInfo, err error) {
	ipInfo = IpInfo{}
...
func (this *Ip2RegionV1) BinarySearch(ipStr string) (ipInfo IpInfo, err error) {
	ipInfo = IpInfo{}
	if this.totalBlocks == 0 {
...
func (this *Ip2RegionV1) BtreeSearch(ipStr string) (ipInfo IpInfo, err error) {
	ipInfo = IpInfo{}
	ip, err := ip2long(ipStr)
